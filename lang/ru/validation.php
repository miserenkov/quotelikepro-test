...
return [
    ...
    'enum_key' => 'Значение поля :attribute некорректно.',
    ...
    'basePrice' => [
        'required' => 'Укажите базовую цену продукта для расчета.',
        'decimal' => 'Базовая цена продукта должна быть числом с не более чем 2 десятичными знаками.',
        'min' => 'Базовая цена продукта должна быть больше или равна :min.',
        'max' => 'Базовая цена продукта должна быть меньше или равна :max.',
    ],
    'quantity' => [
        'required' => 'Укажите количество единиц продукта.',
        'integer' => 'Количество единиц продукта должно быть целым числом.',
        'min' => 'Количество единиц продукта должно быть больше или равно :min.',
        'max' => 'Количество единиц продукта должно быть меньше или равна :max.',
    ],
    'categoryId' => [
        'required' => 'Выберите категорию продукта.',
        'exists' => 'Выберите существующую категорию продукта.',
    ],
    'locationId' => [
        'required' => 'Выберите локацию продажи.',
        'exists' => 'Выберите существующую локацию продажи.',
    ]
];
